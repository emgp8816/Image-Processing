...
msy=[-1 0 1;
 ...
 imagenmrx(find(imagenmrx <T))=0;
 imagenmrx(find(imagenmrx >=T))=255;
 
 imagenmyx(find(imagenmry <T))=0;
 imagenmyx(find(imagenmry >=T))=255;
 
 imagenmpx(find(imagenmpx < T))=0;
 imagenmpx(find(imagenmpx >=T))=255;
 
 imagenmpy(find(imagenmpy < T))=0;
 imagenmpy(find(imagenmpy >=T))=255;
 
 imagenmsx(find(imagenmsx <T))=0;
imagenmsy(find(imagenmsy >=T))=255;
